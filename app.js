...
$(document).ready(function() {
    ...
    for(let i=1;i<=100;i++){
        ...
        $(".input-cell-container").append(row);
            ...
            function changeHeader(ele){ //two-way implementation
        ...
        function updateCell(property,value,defaultPossible){
            $(".input-cell.selected").each(function(){ //add style to cells
               ...
               else{ //if row doesn't exsits then col also doesnt exists
        ...
        $(".icon-bold").click(function(){
            if($(this).hasClass("selected")){
                updateCell("font-weight","",true); //remove bold font
            }
            else{
        ...
        $(".font-size-selector").change(function(){
            ...
            $(".font-size-selector").css("font-size",$(this).val());
        })
        ...
        $(".background-color-picker").change(function(){
            updateCell("background-color",$(this).val()); //select background color
        })

        $(".text-color-picker").change(function(){
            updateCell("color",$(this).val()); // select text-color for cell
        })
